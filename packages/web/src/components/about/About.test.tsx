...
describe('About', () => {
  ...
  describe('sheet interaction', () => {
    it('should open sheet when about button is clicked', async () => {
      ...
      expect(screen.getByText('About Career Compass')).toBeTruthy();
    });
    ...
    it('should display main project description', async () => {
      ...
      expect(
        screen.getByText(
          /This portfolio project demonstrates the capabilities of Career Compass, an AI-powered conversational assistant/,
        ),
      ).toBeTruthy();
    });
    ...
    it('should describe conversational features', async () => {
      ...
      expect(screen.getByText(/structured AI prompting/)).toBeTruthy();
      expect(screen.getByText(/multi-phase conversations/)).toBeTruthy();
      expect(screen.getByText(/structured data output/)).toBeTruthy();
    });
    ...
    it('should display GitHub repository link', async () => {
      ...
      expect(link.getAttribute('href')).toBe('https://github.com/mwarman/career-compass');
    ...
    it('should close sheet when close button is clicked', async () => {
      ...
      const sheetTitle = screen.queryByText('About Career Compass');
